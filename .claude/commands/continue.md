---
description: Resume development after a stop. Loads resume state, repairs incomplete SDLC chains, resumes ticket processing.
argument-hint: No arguments needed — just run /continue to resume
---

Execute the vibecoding **continue** protocol. The full, authoritative protocol lives
in `.github/prompts/continue.prompt.md` — read that file in its entirety and follow it step by step.
