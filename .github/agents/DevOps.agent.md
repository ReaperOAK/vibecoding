...
tools: [vscode, execute, read, agent, edit, search, web, browser, 'awesome-copilot/*', 'github/*', 'memory/*', 'microsoft-docs/*', 'mongodb/*', 'sentry/*', 'sequentialthinking/*', 'terraform/*', ms-azuretools.vscode-containers/containerToolsConfig, todo]
