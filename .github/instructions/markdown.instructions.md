...
4. **Diagrams**: Use Mermaid fenced code blocks for diagrams and flowcharts.
5. **Links**: Use proper markdown syntax for links. Ensure that links are valid
   and accessible.
6. **Images**: Use proper markdown syntax for images. Include alt text for
   accessibility.
7. **Tables**: Use markdown tables for tabular data. Ensure proper formatting
   and alignment.
8. **Line Length**: Limit line length to 400 characters for readability.
9. **Whitespace**: Use appropriate whitespace to separate sections and improve
   readability.
10. **Front Matter**: Include YAML front matter at the beginning of the file
...
- **Diagrams (Mermaid)**: Use fenced code blocks with `mermaid` and keep
  diagrams concise. Prefer flowcharts, sequence diagrams, and state diagrams for
  process-oriented docs.
...
Use Mermaid for diagrams and flowcharts. Keep diagrams small, readable, and
aligned with the written narrative.
